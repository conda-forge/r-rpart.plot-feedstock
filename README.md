...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-rpart.plot-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2269&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-rpart.plot-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-rpart.plot` can be installed with:

```
conda install r-rpart.plot
```

It is possible to list all of the versions of `r-rpart.plot` available on your platform with:
